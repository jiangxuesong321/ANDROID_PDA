...
import com.android.pda.models.PurchaseOrderGiResult;

import java.util.List;

public class PurchaseOrderGiAdapter extends BaseAdapter {
    private LayoutInflater layoutInflater;
    private List<PurchaseOrderGiResult> objects;
    private Context context;
    private boolean isCancel;
    public PurchaseOrderGiAdapter(Context context, List<PurchaseOrderGiResult> objects){
    ...
    public PurchaseOrderGiResult getItem(int position) {
