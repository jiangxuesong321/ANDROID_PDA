...
public class PurchaseOrderAdapter extends BaseAdapter {
    ...
    private List<PurchaseOrderResult> objects;
    private Context context;
    private boolean isCancel;
    public PurchaseOrderAdapter(Context context, List<PurchaseOrderResult> objects){
    ...
    public PurchaseOrderResult getItem(int position) {
