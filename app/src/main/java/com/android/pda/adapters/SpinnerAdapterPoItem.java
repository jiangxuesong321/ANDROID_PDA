...
public class SpinnerAdapterPoItem extends ArrayAdapter<StorageLocation> {
    ...
    public SpinnerAdapterPoItem(Context context, int textViewResourceId, List<StorageLocation> objects) {
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.textView = (TextView) convertView.findViewById(R.id.tv_column1);
