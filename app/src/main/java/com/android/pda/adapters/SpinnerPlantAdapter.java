...
public class SpinnerPlantAdapter extends ArrayAdapter<StorageLocation> {
    ...
    public SpinnerPlantAdapter(Context context, int textViewResourceId, List<StorageLocation> objects) {
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        ...
        if(StringUtils.isNotEmpty(objects.get(position).getPlant())){
            viewHolder.textView.setText(objects.get(position).getPlant());
        } else {
