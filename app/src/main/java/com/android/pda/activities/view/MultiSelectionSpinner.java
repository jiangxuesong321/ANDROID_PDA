...
public class MultiSelectionSpinner extends AppCompatSpinner implements
    ...
    public boolean performClick() {
        ...
        builder.setTitle(context.getString(R.string.text_please_select));
        builder.setMultiChoiceItems(_items, mSelection, this);
        _itemsAtStart = getSelectedItemsAsString();
        builder.setPositiveButton(context.getString(R.string.text_ok), new DialogInterface.OnClickListener() {
            @Override
